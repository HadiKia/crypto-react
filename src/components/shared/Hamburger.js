  ...
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none">
    ...
    >
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="M15.45 1.403A2 2 0 0 1 18 3.326V5h2a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2h.027A2 2 0 0 1 2 18.674V6.754a2 2 0 0 1 1.45-1.923l12-3.428ZM10.14 19H20v-8h-2v4.246a2 2 0 0 1-1.45 1.923L10.14 19ZM18 7h2v2h-2V7ZM4 6.754v11.92l12-3.428V3.326L4 6.754ZM14 9a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z"
        clipRule="evenodd"
      />
    </mask>
    <g mask="url(#a)">
...
const codeIcon = (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none">
    <path
      fill="currentColor"
      fillRule="evenodd"
      d="m16.951 5.373 4.828 6a1 1 0 0 1-.01 1.268l-5 6a.998.998 0 0 1-1.41.128 1.003 1.003 0 0 1-.128-1.41l4.477-5.37-4.316-5.362a1 1 0 0 1 1.56-1.254Zm-9.72-.014A1.001 1.001 0 0 1 8.77 6.64l-4.477 5.37 4.316 5.363a1 1 0 0 1-1.56 1.254l-4.827-6a1 1 0 0 1 .01-1.268l5-6Z"
      clipRule="evenodd"
    />
  </svg>
);
...
const burger1 = "w-6 h-0.5 bg-[#232530] dark:bg-[#f1f1f1] rounded-md duration-700";
const burger2 = " w-4 h-0.5 bg-[#232530] dark:bg-[#f1f1f1] rounded-md duration-700";
const mobileMenu =
  "absolute top-[103px] left-0 right-0 h-screen bg-[#e6e9f2] dark:bg-[#080808] overflow-scroll duration-700 px-4 py-6 pb-28";
  ...
  return (
    <>
      <div className="flex items-center">
        <div
          className={
            menu ? "absolute right-16 top-[38px] text-[#232530]" : "hidden"
          }
        >
          <Switcher />
        </div>
      ...
      <div className={menu ? "hidden" : mobileMenu}>
        <div className="bg-white dark:bg-[#121318] w-full rounded-xl p-5 mt-2 mb-10">
          {/* user */}
          <div className="flex w-full items-center gap-x-4 border-b pb-6 dark:border-[#232530]">
            <img src={profile} alt="profile" />
            <div className="text-left">
              <p className="font-medium text-sm text-[#232530] dark:text-[#f1f1f1]">Allie Grater</p>
              <p className="text-sm font-light text-[#6C7080] dark:text-[#9295A6]">
                alliegrater1234@gmail.com
              </p>
            </div>
          </div>

          <div className="py-4 border-b mb-2 dark:border-[#232530]">
          ...
          <Link
            to="/about"
            onClick={openMenu}
            className={`${menuItemBox} mb-4 pb-6 border-b dark:border-[#232530]`}
          >
            <div className={menuItemTitle}>
              <span>{codeIcon}</span>
