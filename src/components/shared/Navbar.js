...
// styles
const headerStyle = "container max-w-screen-xl mx-auto flex items-center justify-between py-8 md:py-4 px-4";
const ulStyle = 'hidden md:flex items-center gap-x-6 lg:gap-x-8 pt-2'
const liStyle = 'py-2 text-lg font-medium text-[#232530] dark:text-[#f1f1f1] dark:hover:text-[#5367FF] hover:text-[#5367FF] duration-500'

// icons
const logoIcon = (
  <svg xmlns="http://www.w3.org/2000/svg" width="155" height="38" fill="none">
    <path
      className="fill-[#232530] dark:fill-[#5367FF]"
    ...
    />
    <path
      className="fill-[#232530] dark:fill-[#f1f1f1]"
...
const Navbar = () => {
  return (
    <header className="shadow-sm sticky top-0 bg-white dark:bg-[#121318]">
      <div className={headerStyle}>
      <div className="flex items-center gap-x-4 lg:gap-x-8 xl:gap-x-10">
        <Link to="/home">{logoIcon}</Link>
        <ul className={ulStyle}>
          <li>
            <Link className={liStyle} to="/home">Home</Link>
          </li>
          <li>
            <Link className={liStyle} to="/coins">Market</Link>
          </li>
          <li>
            <Link className={liStyle} to="/about">About</Link>
          </li>
         
        </ul>
        <div className="hidden md:block mt-[38px]"><Switcher /></div>
      </div>
