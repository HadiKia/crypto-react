...
// styles
const headerStyle = "container max-w-screen-xl mx-auto flex items-center justify-between py-8 md:pt-6 px-4";
const ulStyle = 'hidden md:flex items-center gap-x-8 pt-2'
const liStyle = 'py-2 text-lg font-medium text-[#232530] hover:text-[#5367FF] duration-500'
