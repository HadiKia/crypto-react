...
const Footer = () => {
  return (
    <div className="pt-10">
      <div className="container max-w-screen-xl mx-auto text-left text[#232530] px-4">
        <div className="mb-10">{logoIcon}</div>

        <div className="flex flex-col gap-y-8 md:flex-row md:gap-x-20 lg:justify-between pb-8 mb-7 border-b">
