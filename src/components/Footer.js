...
// components
import FooterSocialMedia from "./shared/FooterSocialMedia";
...
const Footer = () => {
  return (
    <div className="pt-10 dark:bg-[#121318]">
      <div className="container max-w-screen-xl mx-auto text-left text[#232530] dark:text-[#f1f1f1] px-4">
        <div className="mb-10">{logoIcon}</div>

        <div className="flex flex-col gap-y-8 md:flex-row md:gap-x-20 lg:justify-between pb-8 mb-7 border-b dark:border-[#232530]">
          <div className="flex gap-x-20 lg:w-full lg:gap-x-40 xl:gap-x-60">
            <div>
              <h5 className={footerTitle}>Exchange</h5>
              <div className={footerLinks}>
                <Link to="/">Exchange Home</Link>
                <Link to="/">Margin Trading</Link>
                <Link to="/">Derivatives</Link>
                <Link to="/">Supercharger</Link>
              </div>
            </div>
            <div>
          ...
          <div className="flex gap-x-20 lg:w-full lg:gap-x-40 xl:gap-x-60">
            ...
            <div>
              ...
              <div className={footerLinks}>
                ...
                <Link to="/">But Crypto</Link>
                <Link to="/">Referral</Link>
                <Link to="/">Listing Trading</Link>
              </div>
            </div>
          </div>
        </div>
